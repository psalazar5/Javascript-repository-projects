function getReceipt() {
  //This intializes our string so it can get passes from
  ...
  if (selectedSize === "Personal Pizaa") {
    sizeTotal = 6;
  } else if (selectedSize === "Small Pizza") {
    //Else if statements if picked other size
    sizeTotal = 8;
...
function getTopping(runningTotal, text1) {
  //variables runningtotal and text 1 inside function
  var toppingTotal = 0;
  var selectedTopping = [];
